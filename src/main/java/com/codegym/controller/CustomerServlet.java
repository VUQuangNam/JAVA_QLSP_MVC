...
public class CustomerServlet extends HttpServlet {
    ...
    private void viewCustomer(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if(customer == null){
            dispatcher = req.getRequestDispatcher("WEB-INF/error-404.jsp");
        } else {
            req.setAttribute("customer", customer);
            dispatcher = req.getRequestDispatcher("WEB-INF/views/view.jsp");
        }
        try {
    ...
    private void showDeleteForm(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if(customer == null){
            ...
            req.setAttribute("customer", customer);
            dispatcher = req.getRequestDispatcher("WEB-INF/views/delete.jsp");
        }
        try {
            dispatcher.forward(req, resp);
        } catch (ServletException e) {
    ...
    private void showEditForm(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if(customer == null){
            ...
            req.setAttribute("customer", customer);
            dispatcher = req.getRequestDispatcher("WEB-INF/views/edit.jsp");
        }
        try {
            dispatcher.forward(req, resp);
        } catch (ServletException e) {
